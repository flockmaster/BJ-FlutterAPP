...
void main() {
  group('坐标转换测试', () {
    // 测试数据：北京天安门
    final LatLng tianAnMenWgs84 = LatLng(39.9042, 116.4074);
    ...
    test('距离计算准确性', () {
      // 天安门到故宫（约 1.6 公里）
      LatLng tianAnMen = LatLng(39.9042, 116.4074);
      LatLng guGong = LatLng(39.9163, 116.3972);
    ...
    test('多个城市坐标转换', () {
      ...
      Map<String, LatLng> cities = {
        '北京': LatLng(39.9042, 116.4074),
        '上海': LatLng(31.2304, 121.4737),
        '广州': LatLng(23.1291, 113.2644),
        '深圳': LatLng(22.5431, 114.0579),
      };
